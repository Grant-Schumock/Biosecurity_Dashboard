...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--max-full-text-downloads", type=int, default=1000)
...
def main() -> None:
    ...
    search = FederalRegisterDocumentSearch(
        ...
        max_full_text_downloads=args.max_full_text_downloads,
        keywords=keywords,
    ...
    print(
        ...
        f"with {metadata['full_text_downloads']} full-text downloads."
    )
